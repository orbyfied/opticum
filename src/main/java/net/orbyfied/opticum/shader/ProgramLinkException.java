...
/**
 * Represents an error during shader program linking.
...
public class ProgramLinkException extends RuntimeException {
    ...
    public ProgramLinkException(int code, String message) {
        super(message);
        this.code = code;
    }

    public ProgramLinkException(int code, String message, String desc) {
        super(message);
        this.code = code;
        this.description = desc;
    }

    public ProgramLinkException(int code, String message, Throwable cause) {
        super(message, cause);
        this.code = code;
    }
